...
body.onkeydown = function(e) {
    ...
    const setKeyCodes = new Set([...arrayKeyCodes, e.which || -1])
    arrayKeyCodes = Array.from(setKeyCodes)
};
...
const twoWaysKeys = [32, 255, 251]

const ignoredKeys = []

const leftKeys = [9, 16, 17, 18, 20, 27, 32, 49, 50, 51, 52, 53, 54, 65, 66, 67, 68, 69, 70, 71, 72, 74, 78, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 91, 112, 113, 114, 115, 116, 117, 173, 174, 175, 177, 179, 192]

const rightKeys = [3, 8, 13, 16, 17, 18, 19, 32, 33, 34, 35, 36, 37, 38, 39, 40, 44, 45, 46, 48, 56, 57, 73, 75, 76, 77, 79, 80, 91, 93, 96, 97, 98, 99, 101, 102, 103, 104, 105, 106, 107, 109, 110, 111, 118, 119, 120, 121, 122, 123, 144, 145, 176, 186, 187, 188, 189, 190, 191, 220, 221, 222, 231]

const doNotHaveKeys = [...Array(256).keys()].map((e) => {
    if (rightKeys.includes(e) || leftKeys.includes(e) || wave.includes(e) || smoke.includes(e)) {
        return null
    } else {
        return e
    }
...
console.log("Left keys:", leftKeys)
console.log("Right keys:", rightKeys)
console.log("Don't keys:", doNotHaveKeys)
console.log("Wave:", wave)
console.log({
    mouse: true,
    paw: [255, 255, 255],
    pawEdge: [0, 0, 0],
    key1: Array.from(new Set([...leftKeys, ...twoWaysKeys])),
    key2: Array.from(new Set([...rightKeys, ...twoWaysKeys])),
    smoke: [...smoke],
    wave: [...wave]
})